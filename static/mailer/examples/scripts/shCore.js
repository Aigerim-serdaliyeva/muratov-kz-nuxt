...
(function(e) {
    function c(e, t) {
        ...
        var n = e._xregexp;
        return (
            (e = XRegExp(e.source, h(e) + (t || ""))),
            n &&
                (e._xregexp = {
                    source: n.source,
                    captureNames: n.captureNames
                        ? n.captureNames.slice(0)
                        : null
                }),
            e
        );
    ...
    (XRegExp = function(t, r) {
        ...
        while (a < t.length)
            (h = p(t, a, u, f)),
                h
                    ? (s.push(h.output), (a += h.match[0].length || 1))
                    : (d = o.exec.call(l[u], t.slice(a)))
                    ? (s.push(d[0]), (a += d[0].length))
                    : ((v = t.charAt(a)),
                      v === "["
                          ? (u = XRegExp.INSIDE_CLASS)
                          : v === "]" && (u = XRegExp.OUTSIDE_CLASS),
                      s.push(v),
                      a++);
        return (
            (m = RegExp(s.join(""), o.replace.call(r, n, ""))),
            (m._xregexp = {
                source: t,
    ...
    (l[
        ...
        (XRegExp.addToken = function(e, t, n, r) {
            s.push({
                pattern: c(e, "g" + (f ? "y" : "")),
                handler: t,
        ...
        (XRegExp.execAt = function(e, t, n, r) {
            ...
            return (
                (i.lastIndex = n = n || 0),
                (s = i.exec(e)),
                r && s && s.index !== n && (s = null),
                t.global && (t.lastIndex = s ? i.lastIndex : 0),
                s
            );
        }),
        ...
        (XRegExp.iterate = function(e, t, n, r) {
            var i = c(t, "g"),
                ...
                o;
            while ((o = i.exec(e)))
                t.global && (t.lastIndex = i.lastIndex),
                    n.call(r, o, ++s, e, t),
        ...
        (RegExp.prototype.exec = function(t) {
            ...
            if (n) {
                !u &&
                    ...
                    ((i = RegExp(
                        this.source,
                        o.replace.call(h(this), "g", "")
                    )),
                    o.replace.call((t + "").slice(n.index), i, function() {
                        for (var t = 1; t < arguments.length - 2; t++)
                            arguments[t] === e && (n[t] = e);
                    }));
                if (this._xregexp && this._xregexp.captureNames)
                    for (var f = 1; f < n.length; f++)
                        (r = this._xregexp.captureNames[f - 1]),
                            r && (n[r] = n[f]);
                !a &&
                    this.global &&
                    !n[0].length &&
        ...
        (RegExp.prototype.test = function(e) {
            var t, n;
            return (
                this.global || (n = this.lastIndex),
                (t = o.exec.call(this, e)),
                t &&
                    !a &&
                    this.global &&
                    !t[0].length &&
        ...
        (String.prototype.replace = function(e, n) {
            ...
            return (
                r
                    ? (e._xregexp && (i = e._xregexp.captureNames),
                      e.global || (a = e.lastIndex))
                    : (e += ""),
                Object.prototype.toString.call(n) === "[object Function]"
                    ? (s = o.replace.call(this + "", e, function() {
                          if (i) {
                              arguments[0] = new String(arguments[0]);
                              for (var t = 0; t < i.length; t++)
                                  i[t] &&
                                      (arguments[0][i[t]] = arguments[t + 1]);
                          }
                          return (
                              r &&
                                  e.global &&
                ...
                r && (e.global ? (e.lastIndex = 0) : (e.lastIndex = a)),
                s
            );
        }),
        (String.prototype.split = function(t, n) {
            ...
            return (
                s === r.length
                    ? (!o.test.call(t, "") || a) && i.push("")
                    : i.push(r.slice(s)),
                i.length > n ? i.slice(0, n) : i
            );
        }),
        ...
        XRegExp.addToken(/\(\?<([$\w]+)>/, function(e) {
            return (
                this.captureNames.push(e[1]), (this.hasNamedCapture = !0), "("
            );
        }),
        XRegExp.addToken(/\\k<([\w$]+)>/, function(e) {
            ...
            return t > -1
                ? "\\" +
                      (t + 1) +
                      (isNaN(e.input.charAt(e.index + e[0].length))
                          ? ""
                          : "(?:)")
                : e[0];
        }),
...
if (typeof SyntaxHighlighter == "undefined")
    var SyntaxHighlighter = (function() {
        ...
        function b(t, n) {
            ...
            return (
                (i = e.brushes[r[t]]),
                i == null && n && y(e.config.strings.noBrush + t),
                i
            );
        }
        function w(e, t) {
        ...
        function C(e, t) {
            function u(e, t, n) {
                return (
                    e.substr(0, t) + i.substr(0, n) + e.substr(t + 1, e.length)
                );
            }
            var n = s(e),
                r = "	",
        ...
        function k(t) {
            var n = /<br\s*\/?>|&lt;br\s*\/?&gt;/gi;
            return (
                e.config.bloggerMode == 1 && (t = t.replace(n, "\n")),
                e.config.stripBrs == 1 && (t = t.replace(n, "")),
                t
            );
        }
        function L(e) {
        ...
        function M(t, n) {
            ...
            while ((s = n.regex.exec(t)) != null) {
                var a = u(s, n);
                typeof a == "string" && (a = [new e.Match(a, s.index, n.css)]),
                    (o = o.concat(a));
            }
            return o;
        }
        ...
        var e = {
            ...
            toolbar: {
                getHtml: function(t) {
                    function s(t, n) {
                        return e.toolbar.getButtonHtml(
                            t,
                            n,
                            e.config.strings[n]
                        );
                    ...
                    expandSource: {
                        getHtml: function(t) {
                            ...
                            return e.toolbar.getButtonHtml(
                                t,
                                "expandSource",
                                n ? n : e.config.strings.expandSource
                            );
                        },
                        execute: function(e) {
                            var t = a(e.id);
                    ...
                    help: {
                        execute: function(t) {
                            var n = m("", "_blank", 500, 250, "scrollbars=0"),
                                r = n.document;
                            r.write(e.config.strings.aboutDialog),
                                r.close(),
                                n.focus();
                        }
                    }
            ...
            findElements: function(t, n) {
                var r = n
                        ? [n]
                        : i(document.getElementsByTagName(e.config.tagName)),
                    s = e.config,
                    o = [];
                ...
                function l(e, t) {
                    ...
                    a.left != null &&
                        ...
                        a.right != null &&
                            e.right != null &&
                            ((l = M(e.right, a.right)),
                            f(l, e.index + e[0].lastIndexOf(e.right)),
                            (s = s.concat(l)));
            ...
            (e.Highlighter.prototype = {
                ...
                removeNestedMatches: function(e) {
                    for (var t = 0; t < e.length; t++) {
                        ...
                        for (
                            ...
                            if (s === null) continue;
                            if (s.index > r) break;
                            s.index == n.index && s.length > n.length
                                ? (e[t] = null)
                                : s.index >= n.index &&
                                  s.index < r &&
                                  (e[i] = null);
                ...
                getLineHtml: function(e, t, n) {
                    var r = [
                        ...
                        "number" + t,
                        "index" + e,
                        "alt" + (t % 2 == 0 ? 1 : 2).toString()
                    ];
                    return (
                        this.isLineHighlighted(t) && r.push("highlighted"),
                        t == 0 && r.push("break"),
                ...
                getCodeLinesHtml: function(t, n) {
                    ...
                    for (var a = 0; a < r.length; a++) {
                        ...
                        l != null &&
                            ((c = l[0].toString()),
                            (f = f.substr(c.length)),
                            (c = c.replace(" ", e.config.space))),
                            (f = L(f)),
                            f.length == 0 && (f = e.config.space),
                            (t += this.getLineHtml(
                                a,
                                h,
                                (c != null
                ...
                getMatchesHtml: function(e, t) {
                    ...
                    for (var o = 0; o < t.length; o++) {
                        ...
                        (a = s(u)),
                            (r +=
                                x(e.substr(n, u.index - n), a + "plain") +
                                x(u.value, a + u.css)),
                ...
                getHtml: function(t) {
                    var n = "",
                        ...
                        u;
                    return (
                        this.getParam("light") == 1 &&
                            (this.params.toolbar = this.params.gutter = !1),
                        (className = "syntaxhighlighter"),
                        this.getParam("collapse") == 1 && r.push("collapsed"),
                        (gutter = this.getParam("gutter")) == 0 &&
                            r.push("nogutter"),
                        r.push(this.getParam("class-name")),
                        r.push(this.getParam("brush")),
                        (t = E(t).replace(/\r/g, " ")),
                        (i = this.getParam("tab-size")),
                        (t =
                            this.getParam("smart-tabs") == 1
                                ? C(t, i)
                                : N(t, i)),
                        this.getParam("unindent") && (t = A(t)),
                        gutter && (u = this.figureOutLineNumbers(t)),
                        (s = this.findMatches(this.regexList, t)),
                        (n = this.getMatchesHtml(t, s)),
                        (n = this.getCodeLinesHtml(n, u)),
                        this.getParam("auto-links") && (n = _(n)),
                ...
                getDiv: function(t) {
                    ...
                    return (
                        (n.innerHTML = this.getHtml(t)),
                        this.getParam("toolbar") &&
                            g(l(n, ".toolbar"), "click", e.toolbar.handler),
                        this.getParam("quick-code") &&
                            g(l(n, ".code"), "dblclick", H),
                        n
                    );
                },
                init: function(t) {
